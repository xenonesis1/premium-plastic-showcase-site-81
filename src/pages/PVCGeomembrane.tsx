  ...
  const geomembraneProducts = [
    {
      ...
      description: "Heavy-duty PVC membranes for underground structure protection",
      image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      features: ["Water barrier", "Chemical resistant", "Flexible", "Durable"]
    },
    {
      title: "Foundation Protection",
      description: "Specialized membranes for building foundation waterproofing",
      image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      features: ["Root resistant", "Puncture proof", "Easy installation", "Long life"]
    },
    {
      title: "Industrial Applications",
      description: "High-performance membranes for industrial waterproofing needs",
      image: "https://images.unsplash.com/photo-1566125882500-87e10f726cdc?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      features: ["Temperature resistant", "Chemical proof", "UV stable", "Welding capability"]
    }
  ];
      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              <span className="text-green-400">AQUALINING</span> PVC Geomembrane
            </motion.h1>
            <motion.p
            ...
            >
              Underground Structure Water Proofing Solutions
            </motion.p>
          </div>
        </section>
