  ...
  const services = [
    {
      ...
      description:
        "State-of-the-art PVC manufacturing facilities producing high-quality flooring, leather, and film products for diverse industrial applications.",
      position: "left",
    },
    {
      ...
      description:
        "ISO certified quality management systems ensuring every product meets international standards for durability, safety, and performance.",
      position: "left",
    },
    {
      ...
      description:
        "Tailored manufacturing solutions designed to meet specific industry requirements and customer specifications across various sectors.",
      position: "left",
    },
    {
      ...
      title: "Innovation",
      description:
        "Continuous research and development in PVC technology, bringing innovative products to automotive, construction, and industrial markets.",
      position: "right",
    },
    {
      ...
      description:
        "Expert technical consultation and support services helping customers choose the right PVC solutions for their specific applications.",
      position: "right",
    },
    {
      ...
      title: "Global Reach",
      description:
        "Serving industries worldwide with reliable supply chains and consistent product quality that meets international compliance standards.",
      position: "right",
    },
  ]

  const stats = [
    { icon: <Award />, value: 30, label: "Years Experience", suffix: "+" },
    { icon: <Users />, value: 500, label: "Global Clients", suffix: "+" },
    { icon: <Calendar />, value: 1992, label: "Established", suffix: "" },
    ...
    >
      ...
      >
        <motion.div className="flex flex-col items-center mb-6" variants={itemVariants}>
          ...
          <h2 className="text-4xl md:text-5xl font-light mb-4 text-center">About Premier LeatherCom</h2>
          <motion.div
        ...
        <motion.p className="text-center max-w-2xl mx-auto mb-16 text-[#202e44]/80" variants={itemVariants}>
          Since 1992, Premier LeatherCom has been a leading manufacturer of high-quality PVC products including flooring, 
          artificial leather, films, and specialized materials. We serve diverse industries with innovative solutions that 
            ...
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              ...
              >
                <img
                  ...
                  alt="PVC Manufacturing Facility"
        ...
        >
          <div className="flex-1">
            <h3 className="text-2xl font-medium mb-2">Ready to discuss your PVC requirements?</h3>
            <p className="text-white/80">Let's create the perfect solution for your industry needs.</p>
          </div>
          <motion.button
